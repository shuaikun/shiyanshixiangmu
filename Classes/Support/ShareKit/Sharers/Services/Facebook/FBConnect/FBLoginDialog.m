...
- (void)loadLoginPage {
  NSDictionary* params = @{@"fbconnect": @"1", @"connect_display": @"touch", @"api_key": _session.apiKey,
    @"next": @"fbconnect://success"};
...
- (void)request:(FBRequest*)request didLoad:(id)result {
  ...
  FBUID uid = [object[@"uid"] longLongValue];
  NSString* sessionKey = object[@"session_key"];
  NSString* sessionSecret = object[@"secret"];
  NSTimeInterval expires = [object[@"expires"] floatValue];
