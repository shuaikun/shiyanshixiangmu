...
- (void)load {
  ...
  NSDictionary* postParams = @{@"api_key": _session.apiKey, @"session_key": _session.sessionKey,
    @"preview": @"1", @"callback": @"fbconnect:success", @"cancel": @"fbconnect:cancel", 
    @"feed_info": feedInfo, @"feed_target_type": @"self_feed"};
