...
- (void)load {
  NSDictionary* params = @{@"display": @"touch", @"api_key": _session.apiKey, @"session_key": _session.sessionKey,
    @"ext_perm": _permission, @"next": @"fbconnect:success", @"cancel": @"fbconnect:cancel"};
