...
NSInteger* newColorComponentsFromString(NSString *serializedColor)
{
    NSInteger *componentValues = (NSInteger *)malloc(4 * sizeof(NSInteger));
    memset(componentValues, 0, 4);
...
UIColor * UIColorFromString(NSString *serializedColor)
{
    ...
    CGFloat R = componentValues[0] / 255.0;
    CGFloat G = componentValues[1] / 255.0;
    CGFloat B = componentValues[2] / 255.0;
    CGFloat A = componentValues[3] / 255.0;
