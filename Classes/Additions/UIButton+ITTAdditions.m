...
- (void)setImageName:(NSString*)imageName stretchWithLeft:(NSInteger)LeftCapWidth top:(NSInteger)topCapHeight forState:(UIControlState)State
{
    UIImage *rImage = [UIImage imageNamed:imageName];
    rImage = [rImage stretchableImageWithLeftCapWidth:LeftCapWidth topCapHeight:topCapHeight];
    [self setBackgroundImage:rImage  forState:State];
